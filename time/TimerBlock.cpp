...
//bool TimerBlock::s_registered = BlockList::getInstance().addBlock(TimerBlock::info());


TimerBlock::TimerBlock(CoreController* controller, QString uid)
